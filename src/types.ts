...
export type AdhkarCategory = 'morning' | 'evening' | 'post_salah' | 'postSalah' | 'sleep' | 'sleep_dhohr' | 'sleep_night' | 'general' | 'express';
...
export interface AdhkarItem {
  ...
  isCustom?: boolean;
  order?: number;
  isExpressDaily?: boolean; // Part of "نظام مختصر جدًا للأيام الصعبة" (Minimum Daily Fortress)
  expressCategory?: 'morning' | 'evening' | 'post_salah';
  expressOrder?: number;
}
